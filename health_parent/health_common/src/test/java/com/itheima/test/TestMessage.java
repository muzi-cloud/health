...
public class TestMessage {
    ...
    public void sendMessage() throws Exception{
        ...
        //替换成你的AK
        final String accessKeyId = "LTAIA4ESoe625ivk";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "ob5kvrcmCz9McRPYjLuKkMsTY7Lgjo";//你的accessKeySecret，参考本文档步骤2
        ...
        request.setPhoneNumbers("13528716662");
        //必填:短信签名-可在短信控制台中找到
